...
//                            @RequestParam("tags") String tags, @RequestParam("authors") String authors){
...
//        model.addAttribute("totalPages",5);  // no of papges
//        model.addAttribute("totalItems",10); //records per page
//        model.addAttribute("sortField","createdAt");
//        model.addAttribute("sortDirection","desc");
//        model.addAttribute("currentPage",4);
//
//        model.addAttribute("reverseSortDirection","desc".equals("asc") ? "desc" : "asc");
